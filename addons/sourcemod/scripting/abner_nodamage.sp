...
public Plugin:myinfo = 
{
	...
	author = "abnerfs",
	description = "No damage options",
	version = PLUGIN_VERSION,
	url = "https://github.com/abnerfs/nodamage"
}

public OnPluginStart()
{
	CreateConVar("abner_nodamage_version", PLUGIN_VERSION, "Plugin Version", FCVAR_NOTIFY|FCVAR_REPLICATED);
